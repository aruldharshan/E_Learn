		...
		<div class="container">
         ...
         <div class="service-are" id="service">
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
         					Services Offered in E-Learning Platform<br>
         				</p>
         			</div>
         		</div>
         	</div>
			...
			<section class="work" id="work"><br>
				<h2 id="work-heading" class="text-center" style="font-weight: bold;">FEATURES</h2>
				<p class="text-center">Learn Today To Lead Tomorrow !</p>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
									Frequent questions and answers are provided below.
								</p>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									<div class="panel-heading" id="headingTwo">
										<h4 class="panel-title">
											<a href="#collapseTwo" class="collapsed" data-toggle="collapse" data-parent="#accordian">How does it work?</a>
										</h4>
									</div>
...
<div class="row text-center">
	<h2><b>CONTACT US FOR ANY QUERIES</b></h2><br><br>
	<center>
